...
```php
...
use srag\GeneratePluginInfosHelper\SrCrsMemberGalleryRoleColor\x\GeneratePluginPhpAndXml; 
...
...
```php
...
use srag\GeneratePluginInfosHelper\SrCrsMemberGalleryRoleColor\x\GeneratePluginReadme; 
...
...
```json
  ...
  "update-version": [
    ...,
     "srag\\GeneratePluginInfosHelper\\SrCrsMemberGalleryRoleColor\\x\\UpdateVersion::updateVersion"
    ]
  ...
```
...
```php
...
use srag\GeneratePluginInfosHelper\SrCrsMemberGalleryRoleColor\x\UpdateVersion; 
...
