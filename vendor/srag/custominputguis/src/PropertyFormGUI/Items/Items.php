...
use ilUtil;
use srag\CustomInputGUIs\SrCrsMemberGalleryRoleColor\HiddenInputGUI\HiddenInputGUI;
 ...
 * Class Items
 *
 * @package srag\CustomInputGUIs\SrCrsMemberGalleryRoleColor\PropertyFormGUI\Items
 *
 * @access  namespace
 */
final class Items
