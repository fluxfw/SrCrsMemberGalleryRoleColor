...
```php
...
use srag\ActiveRecordConfig\SrCrsMemberGalleryRoleColor\x\Config\AbstractFactory;
use srag\ActiveRecordConfig\SrCrsMemberGalleryRoleColor\x\Config\AbstractRepository;
...
