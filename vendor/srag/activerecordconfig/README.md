...
```php
...
use srag\ActiveRecordConfig\SrCrsMemberGalleryRoleColor\x\Utils\ConfigTrait;
...
class x {
...
use ConfigTrait;
...
<#x>
<?php
\srag\ActiveRecordConfig\SrCrsMemberGalleryRoleColor\x\Repository::getInstance()->installTables();
?>
```
