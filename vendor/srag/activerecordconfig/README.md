...
namespace srag\Plugins\X\Config
//...
use srag\ActiveRecordConfig\SrCrsMemberGalleryRoleColor\ActiveRecordConfigTableGUI;
//...
...
if (\srag\DIC\SrCrsMemberGalleryRoleColor\DICStatic::dic()->database()->tableExists(\srag\Plugins\X\Config\ConfigOld::TABLE_NAME)) {
    ...
    \srag\DIC\SrCrsMemberGalleryRoleColor\DICStatic::dic()->database()->dropTable(\srag\Plugins\X\Config\ConfigOld::TABLE_NAME);
}
?>
```
