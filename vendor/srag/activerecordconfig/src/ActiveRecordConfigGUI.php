...
namespace srag\ActiveRecordConfig\SrCrsMemberGalleryRoleColor;

use ilPluginConfigGUI;
use ilUtil;
use srag\ActiveRecordConfig\SrCrsMemberGalleryRoleColor\Exception\ActiveRecordConfigException;
