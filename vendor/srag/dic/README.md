...
```php
\srag\DIC\SrCrsMemberGalleryRoleColor\x\DICStatic::dic()->database()->createAutoIncrement(\srag\Plugins\x\x\x::TABLE_NAME, "id");
```
...
```php
...
use srag\DIC\SrCrsMemberGalleryRoleColor\x\DevTools\DevToolsCtrl;
...
    /**
     * @inheritDoc
     */
...
/**
 * ...
 * @ilCtrl_isCalledBy srag\DIC\SrCrsMemberGalleryRoleColor\x\DevTools\DevToolsCtrl: ilXConfigGUI
 */
class ...
...
    /**
